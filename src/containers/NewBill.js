...
export default class NewBill {
  ...
  handleSubmit = (e) => {
    ...
    if (!this.fileName) {
      errorSubmitMsg.textContent = "Aucun fichier valide n'a été sélectionné";
      return console.error("Aucun fichier valide n'a été sélectionné");
    }
    ...
    if (!bill.name || !bill.amount || !bill.date) {
      errorSubmitMsg.textContent = "Veuillez remplir les champs obligatoires";
      return console.error("Veuillez remplir les champs obligatoires");
    }
